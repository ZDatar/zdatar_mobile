...
class HealthDataDetailPage extends StatefulWidget {
  const HealthDataDetailPage({super.key});

  @override
  State<HealthDataDetailPage> createState() => _HealthDataDetailPageState();
}

class _HealthDataDetailPageState extends State<HealthDataDetailPage> {
